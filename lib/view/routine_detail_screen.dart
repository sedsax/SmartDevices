...
class DetailScreen extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                (routine.device.name == "Thermostat")
                    ? heatingSlider(heating, deviceViewModel)
                    : const SizedBox(),
                Padding(
                  padding:
  ...
  Padding heatingSlider(double heating, DeviceViewModel deviceViewModel) {
    return Padding(
  ...
  Row detailAppBar(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        IconButton(
